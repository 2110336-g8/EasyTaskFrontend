            ...
            <div className='p-2 w-full desktop:w-[1200px] desktop-l:w-[1328px] flex items-center justify-between'>
                <div className="flex items-center gap-4">
                    <a href="/" className="relative flex-shrink-0">
                        <Image src="/logo.svg" alt="Logo" width={58} height={32} loading="lazy" className="brightness-normal transition duration-300" />
                    ...
                    <ul className='flex items-center space-x-4'>
                        <li className="inline-flex items-end gap-4">
                            <a className="flex items-end gap-1" href="/">
                                <Image src="/navicons/briefcase.svg" alt="job icon" width={32} height={32} loading="lazy" className="brightness-normal transition duration-300"/>
                        ...
                        <li className="inline-flex items-end gap-4">
                            <a className="flex items-end gap-1" href="/ads">
                                <Image src="/navicons/megaphone.svg" alt="ads icon" width={32} height={32} loading="lazy" className="brightness-normal transition duration-300"/>
                        ...
                        <li className="inline-flex items-end gap-4">
                            <a className="flex items-end gap-1" href="/inbox">
                                <Image src="/navicons/send.svg" alt="inbox icon" width={32} height={32} loading="lazy" className="brightness-normal transition duration-300"/>
